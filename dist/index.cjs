...
function Reel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: classNames, style, "data-spinning": spinning, children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "reeljs-reel__track", children: visibleSymbols.map((symbolId, i) => /* @__PURE__ */ jsxRuntime.jsx(
    Symbol,
    {
      symbolId,
      renderSymbol
